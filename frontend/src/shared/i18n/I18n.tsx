...
const en = {
  ...
  'goal.switchTrack': 'Switch track',
  'goal.yourTracks': 'Your tracks',
  'goal.startNew': 'Start new goal',
  ...
  'learning.noPractices': 'No formative practices for this step.',
  'learning.practiceExercise': 'Practice Exercise',
  'learning.starterCode': 'Starter Code',
  'learning.expectedOutput': 'Expected Output',
...
const vi: Record<TranslationKey, string> = {
  ...
  'goal.switchTrack': 'Chuyển lộ trình',
  'goal.yourTracks': 'Lộ trình của bạn',
  'goal.startNew': 'Bắt đầu mục tiêu mới',
  ...
  'learning.noPractices': 'Không có bài thực hành cho bước này.',
  'learning.practiceExercise': 'Bài Thực hành',
  'learning.starterCode': 'Mã Nền',
  'learning.expectedOutput': 'Đầu ra Mong đợi',
